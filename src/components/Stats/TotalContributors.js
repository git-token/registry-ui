...
class TotalContributorsComponent extends Component {
  constructor() {
    super()
  }
    ...
    return (
      <div style={{ textAlign: 'center', color: '#fff' }}>
        ...
        <div style={{ height: '150px', backgroundColor: 'rgba(0, 0, 0, 0.4)' }}>
          ...
          <h1 style={{ fontSize: '36px' }}>Total Contributors</h1>
        </div>
      </div>
    )
  }
...
const TotalContributors = connect(mapStoreToProps)(TotalContributorsComponent)
