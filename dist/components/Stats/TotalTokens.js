...
var TotalTokensComponent = function (_Component) {
  _inherits(TotalTokensComponent, _Component);

  function TotalTokensComponent() {
    _classCallCheck(this, TotalTokensComponent);

    return _possibleConstructorReturn(this, (TotalTokensComponent.__proto__ || Object.getPrototypeOf(TotalTokensComponent)).call(this));
  }

  _createClass(TotalTokensComponent, [{
...
var TotalTokens = (0, _reactRedux.connect)(mapStoreToProps)(TotalTokensComponent);

exports.default = TotalTokens;